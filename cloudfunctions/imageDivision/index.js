...
// 设置APPID/AK/SK
const APP_ID = '25673679';
const API_KEY = 'lTKy64EI8jDwPzyXlPmZttTZ';
const SECRET_KEY = '4soBMzSFClAQG5LwYxTH56TDhiPzIEwf';
...
exports.main = async (event, context) => {
  ...
  const {
    ...
    error_code,
    error_msg
  } = (await client.bodySeg(imageBase64, {
    type: 'foreground'
  }))
